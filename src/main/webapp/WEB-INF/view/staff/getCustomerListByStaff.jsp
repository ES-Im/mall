					...
					<section class="py-5">
					    <div class="pagination justify-content-center" style="text-align: center; margin-top: 20px; ">
					        ...
					        <c:if test="${lastGroupStart > nextGroupStart}">
							    <a href="${pageContext.request.contextPath}/staff/getCustomerListByStaff?currentPage=${nextGroupStart}">
							        Next
							    </a>
							</c:if>
							
							<c:if test="${(lastGroupStart <= nextGroupStart) && (lastGroupStart > page.currentPage)}">
							    <a href="${pageContext.request.contextPath}/staff/getCustomerListByStaff?currentPage=${lastGroupStart}">
							        Next
							    </a>
							</c:if>
